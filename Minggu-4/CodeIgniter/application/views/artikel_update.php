...
<body>
    ...
    <?php foreach($article as $data){ ?>
        ...
        <section id="profil">
            ...
            <form action="<?= base_url('artikel/ubah'); ?>" method="post">
            <input name="id" id="id" type="hidden" class="form-data" value="<?= $data->id ?>">
            <input name="username" id="username" type="hidden" class="form-data" value="<?= $data->username ?>">
            <div class="form-group">
                <label for="title">Judul :</label>
                <input name="title" id="title" type="text" class="form-data" value="<?= $data->title ?>" required>
            </div>

            <div class="form-group">
                <label for="content">Content :</label>
                <input name="content" id="content" type="text" class="form-data" value="<?= $data->content ?>" required>
            </div>
